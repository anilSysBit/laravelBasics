...
<div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ $url }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{$customer->name}}" class="w-full px-4 py-2 border border-slate-500 rounded-lg text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500">
            </div>
            <div class="mb-4">
                <label for="email" class="block text-slate-500 mb-2">Email</label>
                <input type="email" id="email" name="email" value="{{$customer->email}}" class="w-full px-4 py-2 border border-slate-500 rounded-lg text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="address" name="address" value="{{$customer->address}}" class="w-full px-4 py-2 border border-slate-500 rounded-lg text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500">
            </div>
            <div class="mb-4">
                <label for="dob" class="block text-slate-500 mb-2">Date of Birth</label>
                <input type="date" id="dob" name="dob" value="{{$customer->dob}}" class="w-full px-4 py-2 border border-slate-500 rounded-lg text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="state" name="state" value="{{$customer->state}}" class="w-full px-4 py-2 border border-slate-500 rounded-lg text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500">
            </div>
            <div class="mb-4">
